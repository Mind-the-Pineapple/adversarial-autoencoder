...
Deterministic unsupervised adversarial autoencoder.
 ...
 We are using:
    ...
    - Train Discriminator based on WGAN
"""
import time
...
experiment_dir = output_dir / 'unsupervised_aae_deterministic_convolutional_wasserstein'
...
def train_step(batch_x):
    ...
    for _ in range(n_critic_iterations):
        ...
        clip_D = [p.assign(tf.clip_by_value(p, -0.01, 0.01)) for p in discriminator.weights]
